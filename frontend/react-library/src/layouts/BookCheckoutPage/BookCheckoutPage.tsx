...
export const BookCheckoutPage = () => {
    ...
    //get cur user review for cur book
    useEffect(() => {
    ...
    //get user current loans count, need update when book is checked out
    useEffect(() => {
    ...
    async function submitReview(starInput: number, reviewDescription: string) {
        ...
        try {
            ...
            if (!returnResponse.ok) {
                ...
                throw new Error(`Error: ${returnResponse.status} ${returnResponse.statusText}. ${errorText}`);
            }
